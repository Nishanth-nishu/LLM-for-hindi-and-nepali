...
HINDI = Lexicon(
    ...
    people_names=[
        ...
        # LLM-generated additions (Qwen2.5-3B-Instruct, 2026-09-14), manually
        # QA-reviewed and filtered down from a raw 84-name batch -- see
        # report/phase3_reasoning_report.md for the vocab-expansion note.
        "अमल", "आनंद", "आशा", "आर्य", "अनिल", "अनंत", "अनुज", "चंद्र",
        "दीपांजन", "गणेश", "हरिप्रसाद", "ईशान", "इशाना", "जयप्रभा", "कृष्ण",
        "कुमार", "लाल", "बलेश", "चित्रनाथ", "अभिषेक", "आशीष", "शान्ति",
        "सुमन", "संजीव", "सुनिल", "सुमीर", "शीतल", "श्वेत", "सौम्य",
        "आयुष्मान", "अभिनव", "अशोक", "अश्वत्थामा", "आर्यश्रवण", "अनुभव",
    ],
    object_names=[
        ...
        # LLM-generated additions (Qwen2.5-3B-Instruct, 2026-09-14), manually
        # QA-reviewed and filtered down from a raw 98-object batch (which
        # included a large fraction of animals/materials/abstract words the
        # generator's own self-verification pass failed to catch).
        "कागज", "कप", "पेंसिल", "बॉक्स", "स्कैनर", "बैटन", "कॉपी", "बर्तन",
        "पाइप", "फोटो", "फूटबॉल", "साफ़ा", "मोटर", "स्टैंड", "स्ट्रिंग",
        "कपड़ा",
    ],
    attributes={
...
NEPALI = Lexicon(
    ...
    people_names=[
        ...
        # LLM-generated additions (Qwen2.5-3B-Instruct, 2026-09-14), manually
        # QA-reviewed and filtered down from a raw 97-name batch -- see
        # report/phase3_reasoning_report.md for the vocab-expansion note.
        "सुमित्रा", "राजेन्द्र", "नवीन", "सुरेन्द्र", "सीताराम", "जयदेव",
        "विलास", "हरिता", "प्रेमा", "दीपा", "सुमना", "चन्द्रा", "जयंती",
        "राम", "कालिदास", "रविन्द्र", "सुमित", "प्रेम", "चंद्र", "देवेन्द्र",
        "विश्वरूप", "सुरेश", "सुनील", "मनोज", "विक्रम", "शान्ति", "संजीव",
        "अनिल", "प्रसाद", "प्रियंका", "विशाख", "राज", "निधि", "सुरेन्द्रनाथ",
        "श्रीनाथ", "संजय", "माधव", "प्रीत", "मधुरी", "नवराज", "मोहित", "मौली",
    ],
    object_names=[
        ...
        # LLM-generated additions (Qwen2.5-3B-Instruct, 2026-09-14), manually
        # QA-reviewed and filtered down from a raw 188-object batch (which
        # included animals, materials, and even real person names the
        # generator's own self-verification pass failed to catch).
        "फुटबॉल", "स्क्रीन", "बटन", "सिलेंडर", "म्यान", "फोन", "सारी",
        "गिलास", "बाउल", "बॅकपैक", "प्रिन्टर", "स्मार्टफोन", "प्लेट",
        "क्लिप", "पिपा", "बोर्ड", "क्वाइन", "पासा", "सोफा", "कपड़ा",
        "पैपर", "चौकी", "बेनर",
    ],
    attributes={
